...
function ViewModel() {
    ...
    self.myValues = ko.observableArray([]); // Team Sheet Buttons Not visible

    self.markers = [];

    self.homeDetails = ko.observable();
    self.awayDetails = ko.observable();
    ...
    showGames();
    self.showGames = function(data, event) {
        showGames();
    };
    self.hideGames = function(data, event) {
        hideGames();
    };
